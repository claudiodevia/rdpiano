...
RdBoard::RdBoard(const u8 *temp_ic5, const u8 *temp_ic6, const u8 *temp_ic7,
                 const u8 *temp_progrom, const u8 *temp_paramsrom)
...
void RdBoard::loadRomSet(const u8 *temp_ic5, const u8 *temp_ic6,
                         const u8 *temp_ic7, const u8 *temp_paramsrom)
{
  sound_chip.load_samples(temp_ic5, temp_ic6, temp_ic7);
  params_rom_src = temp_paramsrom;
}

void RdBoard::selectPatch(size_t from_addr)
{
